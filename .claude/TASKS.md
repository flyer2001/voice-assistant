...
- [ ] Разобрать запись доклада Бондаренко по таймкодам (пропущен в эфире)
      Запись: https://youtu.be/Vw4dk8QcVsE · спикер @lvbond · лист ожидания:
      `bench/podlodka/2026-09/watchlist-15-bondarenko.md` (приоритет 1 — оракул).
      Скачать видео, прогнать через whisper, **распознать схемы и диаграммы
      со слайдов по таймкодам** — в докладе они содержательные, текстом не
      передаются. Конспект → заметка myRep «AI как экзокостюм разработчика».
      Done-signal: в заметке заполнены «Тезисы на лету» и «После доклада»,
      кадры со схемами вытащены и описаны.
- [ ] Тот же разбор для записи Кодряна «Рабочее пространство iOS агента»,
      когда появится (16.09, слушаем не в эфире). Активизация уже заполнена.
